...
select a.emp_no as '사번', concat(a.first_name,' ', a.last_name) as '전체이름', c.dept_name as '근무부서' from employees a, dept_emp b, departments c
where a.emp_no = b.emp_no and b.dept_no = c.dept_no and b.to_date = '9999-01-01';
 ...
 select a.emp_no as '사번', concat(a.first_name,' ', a.last_name) as '전체이름', b.salary
